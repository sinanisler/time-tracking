...
>
	<div class="p-6">
		...
		<div x-data="{ newTodoExpanded: false }" class="mb-6">
			<button 
				@click="newTodoExpanded = !newTodoExpanded" 
				type="button" 
				class="w-full flex justify-between items-center px-4 py-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors"
			>
				<span class="text-base font-semibold text-gray-800">
					<i class="fas fa-plus-circle text-purple-500"></i> <?php esc_html_e( 'New TO-DO Item', 'time-tracking' ); ?>
				</span>
				<i class="fas transition-transform duration-200" :class="newTodoExpanded ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
			</button>
			
			<div x-show="newTodoExpanded" x-collapse>
				<form @submit.prevent="addTodo()" class="mt-3 p-4 bg-gray-50 rounded-lg">
					<div class="mb-3">
						<label class="block text-sm font-semibold text-gray-700 mb-1"><?php esc_html_e( 'Task Description', 'time-tracking' ); ?></label>
						<textarea 
							x-model="newTodoText"
							rows="2"
